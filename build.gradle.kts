    ...
    publishing {
        ...
        publications {
            create<MavenPublication>("maven") {
                ...
                pom {
                    name.set("AutoCleanup for JUnit")
                    description.set("Provides annotations for automatically cleaning up resources after a test run.")
                    url.set("https://github.com/Nillerr/autocleanup-junit")

                    licenses {
                        license {
                            name.set("MIT")
                            url.set("https://github.com/Nillerr/autocleanup-junit/LICENSE")
                        }
                    }
